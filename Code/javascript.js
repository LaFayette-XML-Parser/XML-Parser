...
document.getElementById('processButton').addEventListener('click', async () => {
    ...
    let weightValue = '0';
    let priceValue = '0';
    let hasCloserollers = false; // Initialize hasCloserollers
...
propertiesElements.forEach(propertiesElement => {
    ...
    iopCountValue = '0';
    speedValue = '0';
    hasCloserollers = false; // Reset hasCloserollers
...
// Trigger the download and it starts as long as there is something there.
if (totalPrice > 0) { 
